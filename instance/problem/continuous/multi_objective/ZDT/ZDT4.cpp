...
namespace OFEC {
	ZDT4::ZDT4(param_map & v) : problem(v[param_proName], v[param_numDim], 2), ZDT(v[param_proName], v[param_numDim]) { //param_numDim = 10 is suggested
		v[param_numObj] = 2;
		for (int count = 1; count < (int)(v[param_numDim]);++count)
